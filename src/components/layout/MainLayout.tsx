          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-2">
              ...
              <a
                ...
                title="查看 GitHub 项目"
                className="px-3 py-2 rounded-md text-sm font-medium text-slate-300 hover:bg-slate-800 hover:text-white hover:scale-105 transition-all duration-200 flex items-center"
              >
            ...
            <div className="md:hidden border-t border-border bg-card/95 backdrop-blur-md">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={closeMobileMenu}
                  className="block px-3 py-2 rounded-md text-base font-medium text-slate-300 hover:bg-slate-800 hover:text-white transition-colors flex items-center"
                >
